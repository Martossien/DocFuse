...
[![Version](https://img.shields.io/badge/version-0.1.4_beta-orange.svg)](./CHANGELOG.md)
...
[![Tests](https://img.shields.io/badge/tests-388%20passed%20%7C%2039%20skipped-success.svg)](./tests)
...
La dernière préversion est **[`v0.1.4 beta`](https://github.com/Martossien/DocFuse/releases/tag/v0.1.4)**
([notes de version](./docs/releases/v0.1.4.md)).

| Fichier | Lien |
|---|---|
| **Archive portable** (`CorpusOne.exe`) | [Télécharger .zip](https://github.com/Martossien/DocFuse/releases/download/v0.1.4/CorpusOne-0.1.4-beta-windows-x64.zip) |
| **Empreinte SHA-256** | [Télécharger .sha256](https://github.com/Martossien/DocFuse/releases/download/v0.1.4/CorpusOne-0.1.4-beta-windows-x64.zip.sha256) |
| **Archive portable avec OCR** (`CorpusOne-OCR.exe`, Tesseract embarqué) | [Télécharger .zip](https://github.com/Martossien/DocFuse/releases/download/v0.1.4/CorpusOne-OCR-0.1.4-beta-windows-x64.zip) |
| **Empreinte SHA-256** (OCR) | [Télécharger .sha256](https://github.com/Martossien/DocFuse/releases/download/v0.1.4/CorpusOne-OCR-0.1.4-beta-windows-x64.zip.sha256) |
...
The latest pre-release is **[`v0.1.4 beta`](https://github.com/Martossien/DocFuse/releases/tag/v0.1.4)**
([release notes](./docs/releases/v0.1.4.md), French).

| File | Link |
|---|---|
| **Portable archive** (`CorpusOne.exe`) | [Download .zip](https://github.com/Martossien/DocFuse/releases/download/v0.1.4/CorpusOne-0.1.4-beta-windows-x64.zip) |
| **SHA-256 checksum** | [Download .sha256](https://github.com/Martossien/DocFuse/releases/download/v0.1.4/CorpusOne-0.1.4-beta-windows-x64.zip.sha256) |
| **Portable archive with OCR** (`CorpusOne-OCR.exe`, Tesseract bundled) | [Download .zip](https://github.com/Martossien/DocFuse/releases/download/v0.1.4/CorpusOne-OCR-0.1.4-beta-windows-x64.zip) |
| **SHA-256 checksum** (OCR) | [Download .sha256](https://github.com/Martossien/DocFuse/releases/download/v0.1.4/CorpusOne-OCR-0.1.4-beta-windows-x64.zip.sha256) |
